                    ...
                    <div className="container pt-5 border-bottom ">
                          ...
                          <Fade bottom>
                            <div className="col-sm-12 col-md-6">
                                ...
                                <hr class="bg-white" />
                                <h6 class="text-white text-center font-italic"><b>Below you can click on our WEB DEVELOPER cards to find out more about each developer.</b></h6>
                            ...
                            <Slide bottom>
                                <div className="col-sm-6 col-md-4 col-lg-4">
                                    <div className="our-team rounded">
                                        ...
                                        <ul className="social">
                                            <li><a href="https://github.com/singhpri30" className="fa fa-github" aria-hidden="true"></a></li>
                                            <li><a href="https://singhpri30.github.io/Portfolio_1/" className="fa fa-address-card" aria-hidden="true"></a></li>
                                            <li><a href="https://www.linkedin.com/in/priyanka-singh-94014719/" className="fa fa-linkedin" aria-hidden="true"></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </Slide>
