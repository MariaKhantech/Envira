...
export default class AirQualitySearch extends Component {
        ...
        .then((response) => {
          if (response.data.data === "Unknown station") {
            this.setState({
              ...
              showIntroCard: true,
              modalText:
                "Unknown city/station please check your input or try a different location",
              cityInput: "",
            });
          } else {
            this.setState({
  ...
  render() {
    ...
    if (this.state.showAqiCard === true) {
      renderAqiCard = (
            ...
            >
              <Card style={{ width: "22rem" }}>
                <Card.Body>
                  ...
                  <Card.Link href="https://aqicn.org/scale/" target="_blank">
              ...
              <ListGroup.Item className="message">
                <p>
                  ...
                  <ReactTooltip
                    ...
                    show={this.state.show}
                  >
                    <strong>Caution:</strong> {this.state.cautionMessage}
                  </ReactTooltip>
                </p>
              </ListGroup.Item>
            </ListGroup>
    ...
    } else if (this.state.showAqiCard === "") {
      renderAqiCard = null;
    }
